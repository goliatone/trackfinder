...
TrackFinder.prototype.find = function() {
    ...
    if (fs.existsSync(directory)) fs.readdirSync(directory).forEach(fileFound);
    else if (fs.existsSync(directory + '.js')) fileFound(directory + '.js');
